        ...
        {offers.map((offer) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative w-full text-right rounded-xl border-2 p-4 transition-all duration-150",
            ...
            >
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div>
                    <p className="font-semibold text-sm">
                      {offer.quantity} {offer.quantity === 1 ? "قطعة" : offer.quantity <= 10 ? "قطع" : "قطعة"}
                    </p>
                    {offer.label && (
                ...
                <div className="text-left shrink-0">
                  <p className="font-bold text-base">{Number(offer.price).toLocaleString()} د.ج</p>
                  {savings > 0 && (
